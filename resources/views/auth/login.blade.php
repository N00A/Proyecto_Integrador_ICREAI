                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="carousel-content">
                            <h1 style="color: #ffb53e;">¡Crea nuevas historias!</h1>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-content">
                            <h1 style="color:lightgreen;">Usa la escritura creativa</h1>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-content">
                            <h1 style="color:pink;">¿Que es el cadáver exquisito?</h1>
